      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-info">
            ...
            <h5>Electrogati is a company with a difference. Following are the characteristic features that make us distinct from the
            crowded space of other commercial organizations.</h5>
          </div>
