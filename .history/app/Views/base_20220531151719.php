    ...
    <header id="header" class="d-flex align-items-center ">
        <div class="container-fluid container-xxl d-flex align-items-center">
            ...
            <div id="logo" class="me-auto">
                ...
                <a href="<?= base_url() ?>" class="scrollto"><img src="<?= base_url() ?>/public/assets/img/Egati.png"
                        alt="" title=""></a>
            </div>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto  <?= $act ?>" href="<?= base_url() ?>/Buy">Buy</a></li>
                    <li><a class="nav-link scrollto <?= $act ?>" href="<?= base_url() ?>/Sale">Sale</a></li>
                    <li><a class="nav-link scrollto <?= $act ?>" href="<?= base_url() ?>/Rent">Renting</a></li>
                    <li><a class="nav-link scrollto <?= $act ?>" href="<?= base_url() ?>/About">About</a></li>
                    <li><a class="nav-link scrollto <?= $act ?>" href="<?= base_url() ?>/Contact">Contact</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-info">
                        ...
                        <p class="foot-text">Electrogati is a company with a difference. Following are the
